...
const PrivacyPolicy = () => (
  <body style={{ maxHeight: "100%", overflow: "auto", padding: "15px", position: "fixed" }}>
    <strong>Privacy Policy</strong>{" "}
    <p>
      Michael Paccione built the Quake Viz app as a Free app. This SERVICE is
      provided by Michael Paccione at no cost and is intended for use as is.
    </p>{" "}
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which are accessible at Quake Viz unless otherwise
    ...
    <p>
      ...
      hesitate to contact me at michael@mpaccione.com.
    </p>{" "}
    <p>
